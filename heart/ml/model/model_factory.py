...
from heart.entity.artifact_entity import ClassificationMetricArtifact
...
#             train_acc = get_classification_score(y_true=y_train, y_pred=y_train_pred)
#             test_acc = get_classification_score(y_true=y_test, y_pred=y_test_pred)
